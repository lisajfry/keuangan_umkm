...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 via-white to-blue-50">
      <div className="bg-white shadow-xl rounded-2xl w-full max-w-md p-8 border border-gray-100 transition transform hover:scale-[1.01]">
        <h1 className="text-3xl font-bold text-gray-800 mb-2 text-center">Login UMKM</h1>
        ...
        <form onSubmit={submit} className="space-y-5">
          ...
          <button
            type="submit"
            className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg py-2.5 transition duration-300 shadow-md"
          >
            Masuk
          </button>
        </form>
